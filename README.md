...
Run `ng serve` for a dev server. Navigate to `http://messagecat.nathcat.cloudns.cl:4200/`. The application will automatically reload if you change any of the source files.
